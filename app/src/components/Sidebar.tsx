...
const NAV: NavItem[] = [
  ...
  { to: "/favorites", label: "Favorites", Icon: HeartIcon, userOnly: true, requiresConnection: true },
  { to: "/stats", label: "Listening", Icon: SongIcon, userOnly: true, requiresConnection: true },
